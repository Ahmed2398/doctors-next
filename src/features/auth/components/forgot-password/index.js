  ...
  const handleSubmit = (e) => {
    ...
    if (Object.keys(validationErrors).length === 0) {
      ...
      setTimeout(() => {
        ...
        // In a real app, you would make an API call to send the password reset email
      }, 1500);
    }
  };
                  ...
                  <form onSubmit={handleSubmit}>
                    ...
                    <div className="text-center mt-4">
                      <p className="text-muted mb-0">
                        Remember your password? <Link href={LOGIN} className="login-link">Back to Login</Link>
                      </p>
                    </div>
                  </form>
                ) : (
